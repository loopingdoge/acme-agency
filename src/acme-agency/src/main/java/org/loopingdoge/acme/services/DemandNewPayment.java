...
public class DemandNewPayment implements JavaDelegate {

    private final static Logger logger = Logger.getLogger("DemandNewPayment");
    ...
    public void execute(DelegateExecution execution) throws Exception {
        ...
        sessionWs.addSession(
        		...
        		AcmeWaitStateNames.WAIT_BUYER_PAYMENT);
    }
